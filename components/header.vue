<template>
  <div data-role="Header" class="header-header" v-bind:class="rootClassName">
    <div class="header-container">
      <nuxt-link to="/" class="header-navlink">
        <h1 class="header-heading textSM">{{ heading1 }}</h1>
      </nuxt-link>
      <nuxt-link to="/profile" class="header-navlink1">
      ...
      <nuxt-link to="/blog-post" class="header-navlink2">
    ...
    <div data-type="MobileMenu" class="header-mobile-menu">
      <div class="header-top">
        <nuxt-link to="/" class="header-navlink3">
      ...
      <div class="header-mid">
        <nuxt-link to="/profile" class="header-navlink4">
        ...
        <nuxt-link to="/blog-post" class="header-navlink5">
