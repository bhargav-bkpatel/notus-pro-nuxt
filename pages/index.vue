  ...
  <div class="home-container">
    <div class="home-hero">
      ...
      <div class="home-container01">
        <div class="home-container02">
          <h1 class="home-text">Your story starts with us.</h1>
          <span class="home-text01">
            <span></span>
            <span>
              This is a simple example of a Landing Page you can build using Notus
              PRO React. It features multiple CSS components based on the Tailwind
              CSS design system.
            </span>
          </span>
        </div>
    ...
    <div class="home-section1">
      <div class="home-container03">
        <div class="home-container04">
          <h6 class="home-text04">
            <span>WITH BURNED SOLES</span>
            <span></span>
          </h6>
          <h3 class="home-text07 healine">
            I&apos;ve risen with the soles burned
          </h3>
          <span class="home-text08 textXL">
        ...
        <div class="home-cards-container">
          <div class="home-card1">
            ...
            <h6 class="home-text10 textXL">Awarded Agency</h6>
          ...
          <div class="home-card2">
            ...
            <h6 class="home-text12 textXL">Free Revisions</h6>
          ...
          <div class="home-card3">
            ...
            <h6 class="home-text14 textXL">Verified Company</h6>
        ...
        <div class="home-work-with-us">
          <div class="home-container08">
            ...
            <h3 class="home-text16 healine">Work with us is a pleasure</h3>
            ...
            <span class="home-text22">Check Notus PRO React!</span>
          </div>
          <div class="home-container10">
            ...
            <div class="home-container12">
              <h4 class="home-text23 healine">
                <span class="home-text24">Top Notch Services</span>
                <br />
              </h4>
    ...
    <div class="home-section2">
      ...
      <div class="home-growing-company-section">
        ...
        <div class="home-container14">
          ...
          <h3 class="home-text30 healine">A growing company</h3>
          ...
          <div class="home-container16">
            ...
            <span class="home-text32">Carefully crafted components</span>
          </div>
          <div class="home-container18">
            ...
            <span class="home-text33">Amazing page examples</span>
          </div>
          <div class="home-container20">
            ...
            <span class="home-text34">Dynamic components</span>
          </div>
        </div>
      </div>
      <div class="home-container22">
        <h6 class="home-text35"><span>THE ENTOURAGE</span></h6>
        <h3 class="home-text37 healine">
    ...
    <div class="home-section3">
      <div class="home-container44">
        <h6 class="home-text40 textSM"><span>ON THE COASTLINE</span></h6>
        <h3 class="home-text42 healine">We are missing the summer</h3>
        <span class="home-text43 textXL">
        ...
        <div class="home-services">
          ...
          <div class="home-container45">
            ...
            <h1 class="home-text45 textXL">Grow your market</h1>
          ...
          <div class="home-container47">
            ...
            <h1 class="home-text47 textXL">Launch time</h1>
        ...
        <div class="home-contact">
          ...
          <h2 class="home-text49">Type in the bellow form</h2>
          <span class="home-text50 textXL">
          ...
          <div class="home-form">
            <h1 class="home-text51">Want to work with us?</h1>
            <span class="home-text52 textXL">
              Complete this form and we will get back to you in 24 hours.
            </span>
            <span class="home-text53 textXS">FULL NAME</span>
            <input
              type="text"
              placeholder="Full Name"
              class="home-textinput textSM input"
            />
            <span class="home-text54 textXS">EMAIL</span>
            <input
              type="text"
              placeholder="Email"
              class="home-textinput1 textSM input"
            />
            <span class="home-text55 textXS">MESSAGE</span>
            <textarea
              cols="80"
              rows="4"
              disabled="true"
